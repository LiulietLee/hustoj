...
<center>
    <div style="width:90%; margin:0 auto; text-align:left;">
        <div style="text-align:left;font-size:80%;float:left;">[ <a
                    href="newpost.php<?php if ($cid) echo "?cid=$cid&pid=" . $row['pid']; ?>">New Thread</a> ]
        </div>
        <?php if ($isadmin) {
            ?>
        ...
        <table style="width:100%; clear:both">
            <tr align=center class='toprow'>
                <td style="text-align:left">
                    <a href="discuss.php<?php if ($row['pid'] != 0 && $row['cid'] != null) echo "?pid=" . $row['pid'] . "&cid=" . $row['cid'];
                        ...
                        <?php if ($row['pid'] != 0) echo "Problem $pid"; else echo "MainBoard"; ?></a>
			...
			<?php echo $i + 1; ?>#</span>
                        ...
                        <div id="post<?php echo $row['rid']; ?>" class=content
                             style="text-align:left; clear:both; margin:10px 30px">
        ...
        <?php if (isset($_SESSION[$OJ_NAME . '_' . 'user_id'])) { ?>
            ...
            <form action="post.php?action=reply" method=post>
                ...
                <div><textarea id="replyContent" name=content
