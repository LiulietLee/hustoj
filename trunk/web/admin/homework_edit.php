...
<?php 
  ...
  if(!(isset($_SESSION[$OJ_NAME.'_'.'administrator'])||isset($_SESSION[$OJ_NAME.'_'.'contest_creator']))||isset($_SESSION[$OJ_NAME.'_'.'homework_creator'])){
...
if(isset($_POST['startdate'])){
  ...
  if(count($pieces)>0 && strlen($pieces[0])>0){
    $sql_1 = "INTO `contest_problem`(`contest_id`,`problem_id`,`num`, `homework`) VALUES (?,?,?,1)";
